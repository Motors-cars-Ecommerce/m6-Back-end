...
import { createCommentControler, deleteCommentController, listAllCommentsController, retriveCommentsController, updateCommentController } from "../controllers/comments/comments.controller";
